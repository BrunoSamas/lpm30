...
import { Video, Share2, Bot, MapPin, ArrowUpRight } from "lucide-react";
import { Container, Section, SectionHeading, Card } from "@/components/ui";

export const OtherSolutionsAdvisory: React.FC = () => {
    ...
    <Section variant="deep" className="border-t border-white/5 relative">
      <Container>
        <SectionHeading
          ...
          title="Precisa que a M30 faça mais pela sua empresa?"
          description="Conheça nossas soluções completas de execução e inteligência comercial:"
        />
