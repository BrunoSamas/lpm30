...
export const AdvisoryCTA: React.FC = () => {
  return (
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-extrabold text-white leading-tight">
            Seu marketing não precisa de mais improviso. <br />
            <span className="text-[#F26522]">Precisa de um plano claro para o próximo mês.</span>
          </h2>
          ...
          <div className="pt-2 flex items-center justify-center gap-2 text-xs text-[#AEB6C2]">
            ...
            <span>Vamos entender seu momento e avaliar se a Assessoria é o formato certo para sua empresa.</span>
          </div>
        </motion.div>
      </Container>
    </Section>
