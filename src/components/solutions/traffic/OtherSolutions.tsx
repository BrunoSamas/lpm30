...
import { Compass, Video, Bot, MapPin, ArrowUpRight } from "lucide-react";
import { Container, Section, SectionHeading, Card } from "@/components/ui";

export const OtherSolutions: React.FC = () => {
    ...
    <Section variant="dark" className="border-t border-white/5 relative">
      <Container>
        <SectionHeading
          ...
          title="Tráfego funciona ainda melhor quando o restante da estrutura acompanha."
          description="Conheça as outras soluções integradas da M30 Marketing para acelerar seu crescimento:"
        />
