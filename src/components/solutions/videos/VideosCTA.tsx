...
export const VideosCTA: React.FC = () => {
  return (
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight uppercase">
            VOCÊ TEM UMA EMPRESA PARA TOCAR. <br />
            <span className="text-[#F26522]">DEIXA O CONTEÚDO COM A M30.</span>
          </h2>

          <p className="font-body text-base md:text-xl text-[#AEB6C2] max-w-2xl mx-auto">
            Conte para nós o que sua empresa precisa comunicar e ajudamos a escolher o formato de produção ideal.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
              <Button variant="primary" size="lg" fullWidth iconLeft={<Video className="w-5 h-5" />}>
                Quero produzir meus vídeos
              </Button>
            </a>
            <a href="#comparador" className="w-full sm:w-auto">
              <Button variant="secondary" size="lg" fullWidth>
                Comparar Mobile e PRO
              </Button>
            </a>
          </div>
          ...
          <div className="pt-2 flex items-center justify-center gap-2 text-xs text-[#AEB6C2]">
            ...
            <span>Primeiro entendemos sua comunicação. Depois indicamos o formato.</span>
          </div>
        </motion.div>
      </Container>
    </Section>
