...
import { Compass, Share2, Bot, MapPin, ArrowUpRight } from "lucide-react";
import { Container, Section, SectionHeading, Card } from "@/components/ui";

export const OtherSolutionsVideos: React.FC = () => {
    ...
    <Section variant="deep" className="border-t border-white/5 relative">
      <Container>
        <SectionHeading
          ...
          title="Conteúdo é uma parte da estrutura."
          description="Conheça nossas outras soluções para impulsionar a estratégia, atração e vendas da sua empresa:"
        />
